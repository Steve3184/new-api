...
func requestPolicyDefaultOptions() map[string]string {
	...
	defaults["ChannelAutoStatusEmailEnabled"] = strconv.FormatBool(common.ChannelAutoStatusEmailEnabled)
...
func IsRequestPolicyOption(key string) bool {
	...
	switch key {
	case "CheckSensitiveEnabled", "CheckSensitiveOnPromptEnabled", "SensitiveWords", "AutomaticEnableChannelEnabled", "ChannelAutoStatusEmailEnabled", "ChannelDisableThreshold", "monitor_setting.auto_test_channel_enabled", "monitor_setting.auto_test_channel_minutes", "monitor_setting.channel_test_concurrency", "monitor_setting.channel_test_mode", "RetryTimes", "AutomaticRetryStatusCodes", "AutomaticDisableChannelEnabled", "AutomaticDisableStatusCodes", "AutomaticDisableKeywords":
		return true
	}
	return false
}
...
func BuildRequestPolicy(options map[string]string) (*RequestPolicySnapshot, error) {
	...
	for _, key := range []string{"CheckSensitiveEnabled", "CheckSensitiveOnPromptEnabled", "AutomaticEnableChannelEnabled", "ChannelAutoStatusEmailEnabled", "monitor_setting.auto_test_channel_enabled"} {
